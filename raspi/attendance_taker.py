...
# db_host = '192.168.0.114'  # Replace with the IP address of your laptop
db_host = 'localhost'  # Replace with the IP address of your laptop
db_user = 'puphas'        # Replace with your MySQL username
db_password = 'Puphas-2024'    # Replace with your MySQL password
db_name = 'puphas'          # Replace with your database name
    ...
    def attendance(self, id_number):
        ...
        try:
            ...
            if conn.is_connected():
                ...
                if existing_entry:
                    cursor.execute("SELECT * FROM attendance WHERE id_number = %s AND date = %s", (id_number, current_date))
                    conn.commit()
