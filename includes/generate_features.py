...
path_images_from_camera = "../captures/"
...
def main():
    ...
    with open("../captures/features_all.csv", "w", newline="") as csvfile:
        ...
        for person in person_list:
            ...
            logging.info('\n')
        logging.info("Save all the features of faces registered into: ../captures/features_all.csv")

main()
print("Extracted features to CSV")